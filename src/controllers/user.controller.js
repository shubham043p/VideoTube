...
const loginUser = asyncHandler( async (req,res)=>{
   ...
   const user = await User.findOne({
    ...
    //User database wala use hai mongo wala
    // user : database ka instance hai jo create kiya hai
...
const loggedInUser = await User.findById(user._id).
 select("-password -refreshToken") // ye dono nahi chahiye mujhe upr mein
...
const getUserChannelProfile =  asyncHandler(async(req,res)=>{
   ...
   const channel = await User.aggregate([
    ...
    {
        $lookup:{
        from:"subscriptions",             // Subscription : sbhi field mongodb me save hote time lowercase me ho jati hai aur plural me convert ho jati ha
        localField:"_id",
...
?. optionally unwrap krne ke liye kisi se kuchh select krkr lena

aggregate karne par value arrays ate hai 
*/